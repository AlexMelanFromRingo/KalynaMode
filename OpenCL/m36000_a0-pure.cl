 ...
 * License.....: MIT
 *
 * Hashcat mode 36000 — Kalyna-128/128 KPA, attack-mode 0 (dictionary + rules).
 */
...
KERNEL_FQ KERNEL_FA void m36000_mxx (KERN_ATTR_RULES ())
{
...
KERNEL_FQ KERNEL_FA void m36000_sxx (KERN_ATTR_RULES ())
{
  const u64 gid = get_global_id (0);
  if (gid >= GID_CNT) return;
