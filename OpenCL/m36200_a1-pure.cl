 ...
 * License.....: MIT
 *
 * Hashcat mode 36200 — Kalyna-256/256 KPA, attack-mode 1 (combinator).
 */
...
DECLSPEC void m36200_combine32 (PRIVATE_AS const u32 *pw_l, const u32 pw_l_len,
                                ...
                                PRIVATE_AS u32 *key)
{
  ...
  for (int i = 0; i < 8; ++i)
  {
    key[i] = ((u32) buf[i*4+0]) | ((u32) buf[i*4+1] << 8)
...
KERNEL_FQ KERNEL_FA void m36200_mxx (KERN_ATTR_BASIC ())
{
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos++)
  {
    ...
    u32 key[8];
    m36200_combine32 (pw_l, pw_l_len, pw_r, pw_r_len, key);
