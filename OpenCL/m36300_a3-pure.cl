 ...
 * License.....: MIT
 *
 * Hashcat mode 36300 — Kalyna-256/512 KPA, attack-mode 3 (mask brute force).
 */
...
KERNEL_FQ KERNEL_FA void m36300_mxx (KERN_ATTR_BASIC ())
{
...
KERNEL_FQ KERNEL_FA void m36300_sxx (KERN_ATTR_BASIC ())
{
  const u64 gid = get_global_id (0);
  if (gid >= GID_CNT) return;
